...
var http = require('http'), //This module provides the HTTP server functionalities
    ...
    expAutoSan = require('express-autosanitizer'); //This module is for the sanitization process
...
router.use(expAutoSan.allUnsafe); //Part of the sanitization
...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('CA1_IWA.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('CA1_IWA.xsl', 'utf8'); //We are reading in the XSL file
